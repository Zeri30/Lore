    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground">
            ...
            {isLoading ? null : isAuthenticated ? (
              <>
                ...
                <button
                  type="button"
                  onClick={() => logout()}
                  className="rounded-pill border border-border px-4 py-2 text-sm font-medium transition-colors duration-150 hover:bg-surface-muted"
                >
                  Log out
                </button>
              </>
      ...
      >
        ...
        >
          {isLoading ? null : isAuthenticated ? (
            <>
              <span className="text-lg text-foreground/60">Hi, {user?.name}</span>
              <button
                type="button"
                onClick={() => {
                  closeMenu();
                ...
                className="rounded-pill border border-border px-5 py-2.5 text-base font-medium transition-colors hover:bg-surface-muted"
              >
                Log out
              </button>
            </>
